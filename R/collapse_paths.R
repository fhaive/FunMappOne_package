...
#'
#' @import
#' @param kegg_hierarchy
#' @param kegg_mat_cell
#' @param collapse_level, defaults to 1
#' @param col_fun, defaults to function(x){median(x,na.rm = T)}
#' @return list contianing matrix and a dataframe of collapsed matrix & collapsed hierarchy
#' @export
